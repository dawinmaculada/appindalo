    ...
    <div className="min-h-screen flex">
          ...
          <div className="mt-12 space-y-4 text-left max-w-xs mx-auto">
            {[
              ...
              <div key={f} className="flex items-center gap-3">
                <div className="w-5 h-5 rounded-full bg-[#00af38]/20 border border-[#00af38]/40 flex items-center justify-center flex-shrink-0">
                  <div className="w-2 h-2 rounded-full bg-[#00af38]" />
                </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-[#f8fafb]">
        <div className="w-full max-w-sm">
          ...
          <h2 className="text-2xl font-extrabold text-[#1a2332] mb-1">
            Bienvenido de nuevo
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full px-4 py-3 pr-11 text-sm bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#00af38]/30 focus:border-[#00af38] transition-colors"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-[#00af38] text-white font-semibold rounded-xl hover:bg-[#008a2c] active:scale-[0.98] transition-all shadow-lg shadow-[#00af38]/20 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-2"
            >
              {loading ? (
                <>
